...
function qrJquery(){
	...
	return '<script src="'.base_url().RES_DIR.'/adminlte/plugins/qrcode/llqrcode.js" type="text/javascript"></script>    
    <script src="'.base_url().RES_DIR.'/adminlte/plugins/qrcode/script.js" type="text/javascript"></script>
    <script src="'.base_url().RES_DIR.'/adminlte/plugins/qrcode/qrcode.js" type="text/javascript"></script>';
}
